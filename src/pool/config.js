  ...
  db.run(
    `INSERT INTO pool_config
     (id, temperature_topic,
      solar_pump_status_topic, solar_pump_command_topic, solar_pump_priority, solar_pump_max_temp,
      solar_pump_temp_on_seconds, solar_pump_temp_pause_minutes, solar_pump_temp_use_filter,
      filter_pump_status_topic, filter_pump_command_topic, filter_pump_priority, filter_pump_follow_solar,
    ...
    [
      cfg.temperatureTopic,
      cfg.solarPumpStatusTopic, cfg.solarPumpCommandTopic, cfg.solarPumpPriority, cfg.solarPumpMaxTemp,
      cfg.solarPumpTempOnSeconds, cfg.solarPumpTempPauseMinutes, cfg.solarPumpTempUseFilter,
      cfg.filterPumpStatusTopic, cfg.filterPumpCommandTopic, cfg.filterPumpPriority, cfg.filterPumpFollowSolar,
